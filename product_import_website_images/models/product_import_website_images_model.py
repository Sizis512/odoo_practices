...
class ProductImportWebsiteImages(models.TransientModel):
    _inherit = 'product.import.images.base'

    @api.multi
    def do_import_website_images(self):
        self.ensure_one()
        ...
        popup_view_id = self.env.ref("product_import_website_images.popup_message_view").id
        return {
            'name': 'Info',
